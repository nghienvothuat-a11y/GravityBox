...
## Bàn 12 — Lost in glass — 08/09/2026
...
- Bốn góc nhìn đã render từ prefab/camera thật, nhìn rõ ván rời và khoảng không; viền ván nhẹ, tắt phản chiếu trên ván để giảm các mảng trắng chồng nhau. [Ảnh/metadata](Images/Level12/README.md) là fixture đặt pose, không phải bằng chứng giải màn. Đã xóa 58 asset vách/lỗ/vật liệu cũ không còn được tham chiếu.
- Toàn bộ **8/8 EditMode + 63/63 PlayMode = 71/71 passed**, không failure hoặc skipped. EditMode kết thúc 16:38:06 UTC; PlayMode từ 16:38:19 tới 16:38:52 UTC. Bao gồm vỏ cầu ở 408 hướng, nghỉ ổn định với tải đỡ 0,95–1,05 mg, spawn/exit/reset và bộ chọn 12 bàn. [XML/phạm vi kiểm chứng](Verification/README.md).
...
- Đã mở native macOS, chọn màn 12 và nhìn thấy đúng ván rời/bi/lỗ thoát. Sau đó người dùng tiếp tục thao tác; trạng thái cuối quan sát là **BALL OUTSIDE**. [Log của đúng phiên native](Verification/Native-Level12.csv) ghi hoàn thành lúc 16:41:11 UTC, **16,305 giây / 5 lượt kéo / 0 reset**. Không lưu được screenshot native mới vì người dùng đang điều khiển. Lượt hoàn thành nhanh này cho thấy bố cục hiện tại chưa đạt mục tiêu “siêu khó”; đây là bản thử ván rời và chuyển động, cần tinh chỉnh bố trí từ playtest nếu tiếp tục tăng độ khó.
