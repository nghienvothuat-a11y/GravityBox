...
| 4. Lặp thí nghiệm | Reset, pause, chọn hộp, payoff sau thoát rồi tự chuyển | 100 reset mỗi bàn, không giữ state cũ, chỉ chuyển sau khi đủ mọi bi đã thoát |
...
10. Trong mỗi hộp: reset và lặp lại thao tác; đưa bi ra khỏi lỗ thật. Sau khi mọi bi thoát, tốc độ mô phỏng không đổi trong nhịp payoff ngắn rồi game tự tải màn kế.
