# COghe — hồ sơ coghe.tap.v1.05 — Cùng vận hành
...
ID `coghe.tap.v1.05`, vị trí 5/5. Scene `Assets/_Game/Venom/TapCampaign/COgheTap05.unity`, definition `Tap05.asset`. Builder `COgheTapCampaignBuilder.cs`. Ngày 23/09/2026, phiên bản thiết kế 1. User chốt hướng qua Buzz event `553837bdccdd4729a2e978fd25fb4d5bd28d5a1cab799562e4e445c54da3bed4`. Trạng thái **Prototype — đã qua kiểm chứng kỹ thuật trên Mac**. Các cổng nghiệm thu input/gameplay/art/mobile chỉ đạt khi có bằng chứng riêng.

## 2. Mục tiêu trải nghiệm và tiến trình

Một phần giữ tải, một phần thao tác, cùng quay về. Đã thử dao, đổi phần và nhập. Vai trò: giới thiệu/luyện thao tác. Lời hướng dẫn ngắn được phép ở năm màn mở đầu; đây không phải Boss. Giữ giải đố thuần, không nâng chỉ số hoặc đồ mua để giải.

## 3. Bố cục, hình học và điều khiển

Bố cục: dao trái giữa; pad A trái sau; B giữa; gặp ở phải trước; cửa là nắp nâng che lỗ sàn phía sau bên phải. Phòng kích thước .8 × .6 m, sàn y=-.30, nóc y=.02. Camera 55°/25°, điện thoại dọc; nóc vẫn va chạm nhưng không chặn lựa chọn từ trên. Khóa xoay toàn màn. Vật lý: 32 hạt, trọng lực thế giới. Chạm cơ quan giao một hành trình; chạm mặt sàn giao đường đi; chạm phần khác đổi chọn. Vị trí đo cụ thể và điểm đứng/tay nắm do builder khai báo. Bản vẽ bằng quan hệ dưới đây; ảnh/render thật trong artifact kiểm chứng sẽ bổ sung.

```text
Dao -> phần trái giữ A -> phần phải đưa B vào ổ -> nắp sàn lên hết và chốt -> phần trái nhả A -> hai phần về gặp -> nhập -> thoát.
```
