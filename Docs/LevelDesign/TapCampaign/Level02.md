# COghe — hồ sơ coghe.tap.v1.02 — Đưa trở về
...
ID `coghe.tap.v1.02`, vị trí 2/5. Scene `Assets/_Game/Venom/TapCampaign/COgheTap02.unity`, definition `Tap02.asset`. Builder `COgheTapCampaignBuilder.cs`. Ngày 23/09/2026, phiên bản thiết kế 1. User chốt hướng qua Buzz event `553837bdccdd4729a2e978fd25fb4d5bd28d5a1cab799562e4e445c54da3bed4`. Trạng thái **Prototype — đã qua kiểm chứng kỹ thuật trên Mac**. Các cổng nghiệm thu input/gameplay/art/mobile chỉ đạt khi có bằng chứng riêng.

## 2. Mục tiêu trải nghiệm và tiến trình

Đóng/đưa về cũng là bước giải đố. Đã biết một chạm A và nhìn cửa. Vai trò: giới thiệu/luyện thao tác. Lời hướng dẫn ngắn được phép ở năm màn mở đầu; đây không phải Boss. Giữ giải đố thuần, không nâng chỉ số hoặc đồ mua để giải.

## 3. Bố cục, hình học và điều khiển

Bố cục: A giữa sau; B bên trái trước; cửa bên phải sau. Phòng kích thước .8 × .6 m, sàn y=-.30, nóc y=.02. Camera 55°/25°, điện thoại dọc; nóc vẫn va chạm nhưng không chặn lựa chọn từ trên. Khóa xoay toàn màn. Vật lý: 32 hạt, trọng lực thế giới. Chạm cơ quan giao một hành trình; chạm mặt sàn giao đường đi; chạm phần khác đổi chọn. Vị trí đo cụ thể và điểm đứng/tay nắm do builder khai báo. Bản vẽ bằng quan hệ dưới đây; ảnh/render thật trong artifact kiểm chứng sẽ bổ sung.

```text
A ra khỏi bộ truyền -> pin B nhả -> B bật nguồn -> A trở lại ổ -> cửa nâng -> thoát.
```
...
Độ khó mục tiêu: đóng/đưa về cũng là bước giải đố. Độ chính xác chạm/thời điểm thấp; mở đầu không căn xoay. Thời gian suy luận và thao tác đo riêng; chưa có số liệu người mới. Dùng cùng solver/120 Hz/32 hạt, không đổi luật theo chất lượng máy. Ngân sách CPU/GPU/GC cần đo trên thiết bị mục tiêu trước cam kết.
