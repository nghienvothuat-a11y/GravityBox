# COghe — Màn 33 — Đổi đường ống

## 1. Định danh, phạm vi và trạng thái

ID đề xuất `venom.origin.33` · vị trí chơi **33** · Đổi đường ống. Người thiết kế: Codex, 21/09/2026. **Nháp v1** theo yêu cầu Mrk; không tự ghi là đã duyệt. Hồ sơ và phác thảo mới, không thay scene cũ. Chưa có scene/definition/builder mới; chưa kiểm chứng Editor/Mac/mobile.
...
Dùng kỹ năng bò/leo/luồn/đẩy/kéo đã có; không thêm kiểu input. Vai trò: luyện/kết hợp thêm quan hệ so với màn 32. Kết quả chỉ ghi hoàn tất màn, không cấp buff hoặc mở lại Nhà. Điểm mới là quan hệ cơ quan trong bố cục này, không phải kỹ năng có thể mua.

## 3. Phác thảo, hình học, camera và thao tác

![Màn 33 — Đổi đường ống](mockup-v1.png)

Khoang trung tâm S ở dưới nối cụm ống kín tới hai khoang A/B phía trên. Một cụm chọn tuyến T trên ray có hai vị trí A/B, tay nằm tại S. Các lòng ống và cửa trượt đi cùng T tạo một tuyến liên tục tới đúng nhánh; nhánh còn lại bị mặt đặc che. A có cần L nối bằng cáp tới chốt cửa E ở B. B chứa cửa cuối. Ban đầu T=B và E đóng. Các ống có vành bám, bệ vào/ra rộng và đi hai chiều; không có cửa chỉ cho mảnh nhỏ.
...
**Sửa sai:** Đi B sớm có bệ quay đầu để trở về S. T không tự đổi, không có tay điều khiển từ các khoang xa. Kéo dở T về đầu ray cũ; không đóng cắt qua mô.
...
**Quan hệ:** `T=A → tới L → E chốt mở; trở về S → T=B → tuyến thoát liên tục`.

Ống/điều hướng hiện có; cụm chọn tuyến bằng ray và aperture thật là cơ quan mới cần prototype, cập nhật route theo pose, không teleport giữa nhánh.
...
Hai nhánh A/B có ký hiệu và viền khác nhau ngoài màu; thấy lòng ống nào thông thật. Cáp A–E tách nét với ống, không giống nhánh di chuyển.
...
Dự kiến **4 cụm quyết định**, tối đa **1 vai trò cùng lúc** trong lời giải mẫu; đây không phải số cú chạm tối thiểu. Mục tiêu lần đầu 3–4 phút, **chưa đo**. Độ chính xác/thời điểm giữ thấp; cho phép dừng quan sát giữa các bước.

Rủi ro riêng: Ưu tiên chứng minh ống di động không đứt mô hoặc nối nhầm đường. Tay T chỉ có thể thao tác khi toàn bộ cơ thể đã về bệ S; phải đạt bằng vị trí/tầm tiếp cận và cảm biến an toàn có biểu diễn, không cờ nhiệm vụ.
...
- Ưu tiên chứng minh ống di động không đứt mô hoặc nối nhầm đường. Tay T chỉ có thể thao tác khi toàn bộ cơ thể đã về bệ S; phải đạt bằng vị trí/tầm tiếp cận và cảm biến an toàn có biểu diễn, không cờ nhiệm vụ.
...
Vị trí 33/ID 33 là đề xuất mới, chưa đăng ký catalog, scene, save hoặc build list; giữ nguyên các ID cũ. Khi tích hợp kiểm tra mở tiếp/replay/save idempotent, mất điện giữa lưu và ăn mừng; không cấp Nhà lại. Màn 40 kết thúc chương mới, chưa tự đặt màn 41.
...
Phần trên lưu thiết kế minh họa v1. Màn 33 hiện đã được dựng thành `Assets/_Game/Venom/Campaign30/COgheOrigin33.unity`, đăng ký campaign40 màn với ID ổn định `venom.origin.33`. Các khoảng hở, tay nắm và góc nhìn được hiệu chỉnh qua mô phỏng vật lý; quan hệ cơ quan và thứ tự giải giữ theo concept.
