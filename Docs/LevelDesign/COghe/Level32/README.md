# COghe — Màn 32 — Một cầu, hai bến

## 1. Định danh, phạm vi và trạng thái

ID đề xuất `venom.origin.32` · vị trí chơi **32** · Một cầu, hai bến. Người thiết kế: Codex, 21/09/2026. **Nháp v1** theo yêu cầu Mrk; không tự ghi là đã duyệt. Hồ sơ và phác thảo mới, không thay scene cũ. Chưa có scene/definition/builder mới; chưa kiểm chứng Editor/Mac/mobile.
...
Dùng kỹ năng bò/leo/luồn/đẩy/kéo đã có; không thêm kiểu input. Vai trò: luyện/kết hợp thêm quan hệ so với màn 31. Kết quả chỉ ghi hoàn tất màn, không cấp buff hoặc mở lại Nhà. Điểm mới là quan hệ cơ quan trong bố cục này, không phải kỹ năng có thể mua.

## 3. Phác thảo, hình học, camera và thao tác

![Màn 32 — Một cầu, hai bến](mockup-v1.png)

Hộp có bệ trung tâm dài bên trái, hai bến A/B ở bên phải, ngăn bằng vách kín. Một nhịp cầu trên ray trước–sau nối bệ với A hoặc B. Tấm chắn đục lỗ gắn cùng cầu chỉ mở đúng cửa vách tại bến đang nối. A có tay L kéo cáp rút chốt và nâng nắp E ở B; E chốt mở. B có lỗ cuối. Tay điều khiển cầu nằm trên bệ trung tâm, có đường bám chạy dọc ray. Dưới cầu có sàn an toàn và lối leo về bệ.
...
**Sửa sai:** Chọn B trước thì trở về bệ rồi đổi A. Cầu không tự chạy; tay ở bệ khiến người chơi trở về trước khi chuyển. Rơi xuống có lối leo lại; L giữ kết quả.
...
**Quan hệ:** `cầu=A → tới L → E chốt mở; trở về bệ → cầu=B → tới E`.

Tái dùng ray/cầu/cửa; cần cầu hai trạm và tấm chắn hai cửa vật lý. Không giả định COgheAssemblyBridge đã hỗ trợ cấu hình này.
...
Cáp L–E đi dọc vách nhìn thấy; khi thử B trước, E còn chốt. Cửa trên vách khớp đúng mặt cầu, không có đích giả trên khoảng trống.
...
Dự kiến **3 cụm quyết định**, tối đa **1 vai trò cùng lúc** trong lời giải mẫu; đây không phải số cú chạm tối thiểu. Mục tiêu lần đầu 2–4 phút, **chưa đo**. Độ chính xác/thời điểm giữ thấp; cho phép dừng quan sát giữa các bước.

Rủi ro riêng: Vách phải kín tới nóc và hai đầu, tấm chắn che cửa không được chọn; leo vỏ hộp không bỏ qua L. Không cho dịch cầu từ xa khi mô còn trên cầu.
...
- Vách phải kín tới nóc và hai đầu, tấm chắn che cửa không được chọn; leo vỏ hộp không bỏ qua L. Không cho dịch cầu từ xa khi mô còn trên cầu.
...
Vị trí 32/ID 32 là đề xuất mới, chưa đăng ký catalog, scene, save hoặc build list; giữ nguyên các ID cũ. Khi tích hợp kiểm tra mở tiếp/replay/save idempotent, mất điện giữa lưu và ăn mừng; không cấp Nhà lại. Màn 40 kết thúc chương mới, chưa tự đặt màn 41.
...
Phần trên lưu thiết kế minh họa v1. Màn 32 hiện đã được dựng thành `Assets/_Game/Venom/Campaign30/COgheOrigin32.unity`, đăng ký campaign40 màn với ID ổn định `venom.origin.32`. Các khoảng hở, tay nắm và góc nhìn được hiệu chỉnh qua mô phỏng vật lý; quan hệ cơ quan và thứ tự giải giữ theo concept.
