# COghe — Hồ sơ level `coghe.tap.v1.07` — 47 · Bốn điểm dừng

Nguồn chuẩn: [quy tắc](../../../COGHE_LEVEL_DESIGN_RULES.md), [Day Lab](../../../ArtDirection/COghe/STYLE_RULES.md), [hồ sơ nguồn](../../TapCampaign/Level07.md). Theo mẫu LEVEL_TEMPLATE; revision 1, Codex, 23/09/2026.

## 1. Định danh, phạm vi và trạng thái

ID `coghe.tap.v1.07`, vị trí 47. Scene `Assets/_Game/Venom/Campaign30/COgheOrigin47.unity`; definition `Definitions/Slot47.asset` cùng thư mục. Builder `Assets/_Game/Editor/COgheCampaign55Builder.cs`. Mrk giao qua event `f9df450879e1d3467a4081de6a1185331dee050738c4b648c63d4fdf13dba34d`. Trạng thái **Prototype — đã kiểm chứng gameplay và input replay trên Mac**; không gán đạt mobile/người mới từ test Mac. Bằng chứng tập trung tại `Artifacts/COgheCampaign55`.

## 2. Mục tiêu trải nghiệm và vị trí trong tiến trình

Chốt 2 nhả nguồn; chốt 4 nối bộ truyền. Màn thường, hướng dẫn ngắn theo cơ quan. Không thêm chỉ số, vật phẩm bắt buộc hoặc phần thưởng vĩnh viễn. Giữ nhận diện nội dung Tap đã chơi.
...
Chốt 2 nhả nguồn; chốt 4 nối bộ truyền. Dự kiến một thao tác cơ quan mỗi lần, không yêu cầu canh thời gian. Số vai trò/cơ quan theo hồ sơ nguồn. Khó quan sát/tap nhầm không phải mục tiêu thiết kế. FPS mobile mục tiêu 60; p95/GC/GPU/nhiệt và ngân sách bộ nhớ chưa đo/chốt. Không suy ra hiệu năng từ số khối.
