# COghe — Hồ sơ level `venom.origin.54` — 54 · Đẩy và kéo
...
ID `venom.origin.54`, vị trí 54. Scene `Assets/_Game/Venom/Campaign30/COgheOrigin54.unity`; definition `Definitions/Slot54.asset` cùng thư mục. Builder `Assets/_Game/Editor/COgheCampaign55Builder.cs`. Mrk giao qua event `f9df450879e1d3467a4081de6a1185331dee050738c4b648c63d4fdf13dba34d`. Trạng thái **Prototype — đã kiểm chứng gameplay và input replay trên Mac**; không gán đạt mobile/người mới từ test Mac. Bằng chứng tập trung tại `Artifacts/COgheCampaign55`.

## 2. Mục tiêu trải nghiệm và vị trí trong tiến trình

A/C đẩy tới, B kéo về. Màn thường, hướng dẫn ngắn theo cơ quan. Không thêm chỉ số, vật phẩm bắt buộc hoặc phần thưởng vĩnh viễn. Luyện cơ chế đẩy/kéo của màn hiển thị 19 (legacy content 16), không học thêm động từ mới.
...
A/C đẩy tới, B kéo về. Dự kiến một thao tác cơ quan mỗi lần, không yêu cầu canh thời gian. 3 ray động, một cơ thể; so với ba ray ở màn 19. Khó quan sát/tap nhầm không phải mục tiêu thiết kế. FPS mobile mục tiêu 60; p95/GC/GPU/nhiệt và ngân sách bộ nhớ chưa đo/chốt. Không suy ra hiệu năng từ số khối.
