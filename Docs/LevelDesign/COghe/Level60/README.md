# COghe — Hồ sơ level 60 — BOSS · Vỏ ốc
...
ID `venom.origin.60`, vị trí 60; v1, cập nhật 24/09/2026 bởi Codex.
Scene `Assets/_Game/Venom/Campaign30/COgheOrigin60.unity`; definition `Definitions/Slot60.asset`.
...
Xoay qua chuỗi khúc cong để tới miệng vỏ. Boss tổng hợp chỉ thao tác xoay, không gợi ý lời giải trong HUD.
...
Boss không có lesson/hint; không mở phần thưởng mới.
...
Lời giải dành cho tác giả/test: Đưa từng khúc tiếp theo xuống thấp, xoay dần theo đường xoắn; cuối cùng miệng vỏ hướng xuống.
...
![Màn60 trong bản Mac](RUNTIME_START_2026_09_24.png)
