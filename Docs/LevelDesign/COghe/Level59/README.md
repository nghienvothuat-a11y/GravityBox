# COghe — Hồ sơ level 59 — Đầu lâu pha lê
...
ID `venom.origin.59`, vị trí 59; v1, cập nhật 24/09/2026 bởi Codex.
Scene `Assets/_Game/Venom/Campaign30/COgheOrigin59.unity`; definition `Definitions/Slot59.asset`.
...
Đầu lâu bắt đầu nằm nghiêng; xoay từ khoang sọ xuống lỗ hàm. Luyện tập trong hình sọ; hốc mắt và răng là nét khuôn kín.
...
Lời giải dành cho tác giả/test: Xoay đầu lâu về tư thế hàm thấp hơn sọ, căn miệng hàm xuống và chờ toàn bộ mô ra ngoài.
...
![Màn59 trong bản Mac](RUNTIME_START_2026_09_24.png)
