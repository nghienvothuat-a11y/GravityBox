# COghe — Hồ sơ level 58 — Ấm nghiêng
...
ID `venom.origin.58`, vị trí 58; v1, cập nhật 24/09/2026 bởi Codex.
Scene `Assets/_Game/Venom/Campaign30/COgheOrigin58.unity`; definition `Definitions/Slot58.asset`.
...
Rót sinh vật từ bụng ấm vào vòi cong. Kết hợp: đổi hướng khi sinh vật vào phần vòi.
...
Lời giải dành cho tác giả/test: Đưa bụng xuống phía vòi rồi xoay tiếp để miệng vòi hướng xuống.
...
![Màn58 trong bản Mac](RUNTIME_START_2026_09_24.png)
