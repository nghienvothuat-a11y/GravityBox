# COghe — Hồ sơ level 57 — Mặt nạ thủy tinh
...
ID `venom.origin.57`, vị trí 57; v1, cập nhật 24/09/2026 bởi Codex.
Scene `Assets/_Game/Venom/Campaign30/COgheOrigin57.unity`; definition `Definitions/Slot57.asset`.
...
Căn khoang dẹt và lỗ lệch trên trán. Luyện tập: khoang rộng ngang nhưng nông theo chiều sâu.
...
Lời giải dành cho tác giả/test: Lật và nghiêng nhẹ về phía lỗ lệch; phần trán dẫn tới lỗ.
...
![Màn57 trong bản Mac](RUNTIME_START_2026_09_24.png)
