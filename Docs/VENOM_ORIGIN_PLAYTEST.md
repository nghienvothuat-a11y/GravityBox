...
- Camera 08 nhìn 3/4 từ bên trái, góc nhìn xuống 30°, yaw 42°, ViewRadius giảm từ 0,59 xuống 0,52: hai hộp lớn hơn khoảng 13,5% trên màn hình, vẫn nằm trọn trong khung dọc. Nóc, vành bám/miệng ống và lỗ cuối cùng đều chọn được từ góc cố định này; nóc không chắn đường chọn miệng ống.
...
- Tốc độ mục tiêu bò/leo: **0,1638 m/s**, tăng thêm 30% từ 0,126 m/s; sinh vật giảm tốc khi tới gần điểm được chỉ.
...
- Vành ống có phản xạ bắt rơi sau ít nhất hai điểm tiếp xúc da thực. Pha giữ điểm bám và hãm kéo dài tối đa 0,55 giây, giới hạn tầm với 0,15 m từ điểm đã chạm và giữ giới hạn lực vận động hiện có. Hai xúc tu biểu diễn chỗ bám trong lúc hãm, HUD hiện “Bám vành ống”. Sau khi ổn định, luồng chui ống tự tiếp quản khi có ít nhất hai điểm bám thật trên collider vành vào, trong bán kính 0,11 m, và tốc độ đã giảm xuống tối đa 0,25 m/s. Không mở rộng vùng bắt từ xa hoặc teleport sinh vật.
...
- 17/09/2026: tăng thêm 30% tốc độ bò/leo, 0,126 → 0,1638 m/s. Ba kiểm tra hiện có đạt: tới lỗ sàn, qua vách rồi quay lại, leo nóc/bắt vành/chui ống bài 08. XML: `Artifacts/COgheExpansion/speed-30.xml`. Build Mac thành công. Giữ nguyên lực bám, trọng lực, trượt thụ động và tốc độ cơ quan.

- 17/09/2026 — màn 08: camera gần hơn, tự chui ống sau khi bắt vành và hãm. **6/6 kiểm tra màn 08 đạt**, gồm khung hình dọc chứa đủ hai hộp/ống, bắt vành ở giữa và lệch hai bên 35 mm không cần lệnh vào ống, rơi hụt tiếp tục xuống sàn, chạm nóc và đường giải đầy đủ. XML: `Artifacts/COgheExpansion/level08-auto.xml`; ảnh: `Artifacts/COgheExpansion/Frames/08-closer-overview.png`.
- Bản Mac cho thay đổi màn 08 build thành công, đã mở và kiểm tra khung hình thật cùng HUD: cả hai hộp và ống nối nằm trọn vùng chơi. Để sẵn màn 08 cho lượt test tiếp theo.
