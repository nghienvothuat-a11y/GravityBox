# Phạm vi kiểm chứng prototype tám hộp
...
- Catalog: đúng tám hình Circle/Square/Triangle/LShape/UShape/Annulus/Dumbbell/Star, Earth gravity, free rotation, không cơ cấu phụ, kích thước/khối lượng tương ứng thép đặc.
...
- Prefab thật: spawn clearance, thành hộp theo từng cạnh contour gồm cả thành trong vành khuyên, sàn/nắp hỗ trợ đúng vùng có thể chơi và để trống phần khuyết/lõi rỗng; contact với cube, nằm yên, containment khi nghiêng và lỗ thoát thật trên cả tám bàn.
