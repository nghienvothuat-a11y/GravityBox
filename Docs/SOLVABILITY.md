...
- Lifecycle/input: mỗi body được áp gravity một lần (hai targets ở bàn 09, ba ở bàn 10), 100 reset mỗi bàn gồm cả root, mọi bi và prop, cleanup, tự chuyển sau khi đủ bi thoát, manual Next để test, pause, mouse/touch và tốc độ mô phỏng không đổi trong payoff. Bộ chọn tới được bàn 12 và quay lại bàn 11; nút xem tầng không tạo rotation input.
