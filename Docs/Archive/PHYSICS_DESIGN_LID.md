# Thiết kế nắp rơi — tài liệu lịch sử

L06 và nắp rơi đã được đưa ra ngoài catalog đang chơi. Tài liệu này giữ lại quyết định vật lý của giai đoạn trước. Xem [triết lý hiện tại](../PHYSICS_DESIGN_PRINCIPLES.md).
