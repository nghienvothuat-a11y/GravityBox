...
## 2. Một sinh vật, hai trải nghiệm

| | Trong hộp giải đố | Ở nhà |
| --- | --- | --- |
| Vai trò người chơi | Hướng dẫn sinh vật vượt cơ quan và đưa toàn bộ vật chất ra lỗ | Xây chỗ ở, chăm sóc, chơi và tạo những tương tác riêng |
| Tiến bộ | Hiểu luật, học kỹ năng, phối hợp nhiệm vụ tốt hơn | Có đồ vật, món ăn, cử chỉ và ký ức tương tác mới |
...
Các thông số vật lý vẫn tồn tại để phát triển và cân bằng game. Chúng là cấu hình do thiết kế kiểm soát, không phải tài sản người chơi mua/tăng. Điều kiện môi trường có thể tác động vật lý theo luật được dạy và áp dụng nhất quán cho mọi người.

## 4. Nội dung mua và tương tác trong nhà

Các ví dụ sau là đề xuất thư viện đầu, chưa phải danh sách hàng hóa đã chốt:

| Nhóm | Ví dụ | Sinh vật làm gì | Giá trị |
| --- | --- | --- | --- |
| Nội thất / chỗ nghỉ | Đệm, ổ nhỏ, đèn, vật trang trí | Bò tới, cuộn thân nằm, thò đầu nhìn từ ổ | Cá nhân hóa nơi ở, tạo cảnh sinh hoạt |
| Đồ chơi có tương tác | Bóng, vòng, vật treo | Chạm dò, đẩy lăn, cuộn quanh, kéo rồi nhìn vật đung đưa | Những tình huống vật lý và phản ứng vui |
...
## 5. Ranh giới giữa nhà và campaign

Để giữ giải đố thuần, nội dung nhà không thay khối lượng, lực bám, tốc độ, khả năng chui khe, kỹ năng cần để giải màn hoặc điều kiện mở cửa. Đồ ăn không cấp buff giúp giải cơ quan; mua animation không mua khả năng kéo/ấn/giữ. Những động tác cần đọc lời giải và tiếp xúc vật lý luôn thuộc bộ cơ bản.

Không cần cho ăn, mua đồ hoặc đạt mức tình cảm để vào màn tiếp theo. Không cho sinh vật yếu đi, quên bài hoặc bỏ lệnh vì lâu không về nhà. Hành vi ở nhà có thể nhớ món từng chọn và đồ đã chơi; các ký ức đó phục vụ phản ứng và sự thân quen, không thay kết quả puzzle.

Mặc định animation mua thêm dùng ở nhà. Nếu sau này cho dùng trong đoạn ăn mừng, phải giữ thời gian chuyển màn, pause và khung nhìn rõ như nhau; không thay vật lý trước khi toàn bộ sinh vật đã thoát. Trang trí/ngoại hình không được làm người chơi khó đọc hình dạng cơ thể trong campaign.

Nhà và campaign dùng cùng danh tính sinh vật. Mô phỏng đồ ăn/đồ chơi ở nhà không mang khối lượng vật lý hay lực chưa giải phóng sang màn giải đố. Nhớ được món ăn không đồng nghĩa thể hiện một mô hình sinh học thật.
...
Thư viện dùng các nhóm dò, bám, kéo, đẩy, cuộn, ăn và cử chỉ; biến thể thay nhịp và dáng. Tương tác vật lý cơ bản được kiểm chứng trước khi sản xuất nhiều biến thể mua thêm. Sinh vật không tự hiểu đồ vật hoàn toàn mới chỉ từ mesh 3D của nó.

Đề xuất nhà là một scene riêng; chỉ tải tài nguyên cần cho đồ đã đặt và cử chỉ đang xem/dùng. Dùng giới hạn số đồ hoạt động vật lý đồng thời và độ chi tiết hình ảnh phù hợp thiết bị; thư viện lớn không có nghĩa chạy mọi animation cùng lúc. Đo trên điện thoại trước khi chốt số đồ/trang trí được đặt. Không hạ năng lực giải đố theo cấu hình máy.
...
Nghiệm thu cần kiểm tra: đường giải và thông số campaign giống nhau dù không có đồ hay sở hữu nhiều đồ; phản ứng học nhìn thấy được nhưng không giải thay; về nhà/tiếp tục không mất tiến trình; sở hữu/bố trí lưu đúng; đổi/hủy tương tác không để lực hoặc ràng buộc treo lại; vật thể và sinh vật không xuyên sàn; hiệu năng khi nhiều đồ hoạt động được đo trên điện thoại.

Lần cập nhật này chỉ chốt và đồng bộ tài liệu. Chưa tạo scene nhà, cửa hàng, đồ ăn, animation mới, thanh toán hoặc bản build mới.
