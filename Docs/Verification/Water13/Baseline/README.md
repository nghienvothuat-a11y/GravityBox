# Bằng chứng lưu trữ — nước bản đầu (08525a4)

Đây là kết quả trước khi hiệu chỉnh cản sát thành/added mass. Xem [kết quả hiện tại](../README.md).
...
Render có graphics đạt ba góc; shader không có lỗi. [Ảnh và metadata bản đầu](../../../Images/Level13/README.md) ghi chuyển động vật lý liên tục từ spawn, với 0/8/42 hạt wake ở ba thời điểm. Fixture không lưu thay đổi vào Gameplay scene.
