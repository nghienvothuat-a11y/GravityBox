...
- `LevelManager` sở hữu load/reset, roster bi, props tách khỏi gốc, lực, sự kiện và chuyển catalog. Sau màn 100 không tự quay lại màn 1. Người chơi chủ động chuyển tiếp.
