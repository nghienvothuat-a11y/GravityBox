...
// Generated from Assets/_Game/Tests/PlayMode/COgheBoss30ScreenTests.cs
// SHA256 ad4a528a146ea5ed8ea3c6acd65ff9a3f25a9001132d74f13479b8d505a39f9e
...
namespace GravityBox.Venom.ChapterProof
{
    ...
    public sealed class COgheBoss30ScreenReplay
    {
        ...
        private IEnumerator Wait(float seconds, Func<bool> condition, string reason, Action refresh = null)
        {
            ...
            if (!condition()) yield return COgheChapterProofCapture.Request(game, "30-screen-failed");
        ...
        public IEnumerator Campaign30WholeSolutionUsesScreenCommands()
        { yield return FullSolution(480, 800); }

        public IEnumerator Boss30TallPortraitWholeSolutionUsesScreenCommands()
        ...
        private IEnumerator FullSolution(int viewportWidth, int viewportHeight)
        {
            ...
            yield return COgheChapterProofCapture.Request(game, "30-screen-completed");
