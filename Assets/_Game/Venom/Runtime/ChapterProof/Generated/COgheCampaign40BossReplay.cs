...
namespace GravityBox.Venom.ChapterProof
{
    ...
    public sealed class COgheCampaign40BossReplay
    {
        ...
        private IEnumerator Wait(float seconds, Func<bool> condition, string reason, Action refresh = null)
        {
            ...
            if (!condition()) yield return COgheChapterProofCapture.Request(game, $"{game.Definition.Order:00}-failed-two-stage");
