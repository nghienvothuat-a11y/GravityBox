...
namespace GravityBox.Tests
{
    public sealed class COgheCampaign40RouteTests
    {
        ...
        [UnityTest] public IEnumerator Bridge32CompactPortraitScreenSolution()
        {yield return Bridge32ScreenSolution(480,800);}
        [UnityTest] public IEnumerator Bridge32TallPortraitScreenSolution()
        {yield return Bridge32ScreenSolution(720,1612);}

        [UnityTest] public IEnumerator Audit32WrongBankAndReverseBridgeRecoverToWin()
        ...
        [UnityTest] public IEnumerator Level33ChoosesAOpensEReturnsToSAndChoosesBToWin() {yield return Pipe33Solution(false);}
        [UnityTest] public IEnumerator Audit33VisitsBFirstReturnsAndChangesSelectorMidStroke() {yield return Pipe33Solution(true);}
        ...
        [UnityTest] public IEnumerator Level34RetractsBParksXPassesGReturnsXRestoresBAndWins() {yield return Crossing34Solution(false);}
        [UnityTest] public IEnumerator Audit34WrongOrderAndMidStrokeReversalRecoverToWin() {yield return Crossing34Solution(true);}
