...
{
    public enum ContainerShape { Circle, Square, Triangle, LShape, UShape, Annulus, Dumbbell, Star, GravityLock, MechanicalMaze, LayeredMaze, SphereMaze, WaterBox, MercuryBox, LionHead }
